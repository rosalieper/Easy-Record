...
<button type="button" class="btn btn-primary btn-lg">Add Option</button>
<button type="button" class="btn btn-primary btn-lg">Add Lecturer</button>
<button type="button" class="btn btn-primary btn-lg">Add Department</button>
